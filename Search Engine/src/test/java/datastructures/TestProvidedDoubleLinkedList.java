 ...
 *
 * So, do not write your double linked list tests in this file.
 * Write your double linked list tests in TestDoubleLinkedList.java.java instead.
 */


public class TestProvidedDoubleLinkedList extends BaseTest {
    /**
